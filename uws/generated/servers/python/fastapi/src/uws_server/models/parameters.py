...
from uws_server.models.parameter import Parameter
try:
...
class Parameters(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "parameter": [Parameter.from_dict(_item) for _item in obj.get("parameter")] if obj.get("parameter") is not None else None
        })
        return _obj
