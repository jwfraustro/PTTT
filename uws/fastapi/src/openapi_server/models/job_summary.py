...
class JobSummary(BaseModel):
    ...
    quote: Optional[str] = Field(
        default=None,
        description='A Quote predicts when the job is likely to complete - returned at /{jobs}/{job_id}/quote "don\'t know" is encoded by setting to the XML null value xsi:nil="true" ',
    )
    creation_time: Optional[str] = Field(
        default=None,
        description="The instant at which the job was created.  Note that the version 1.1 of the specification requires that this element be present. It is optional only in versions 1.x of the schema for backwards compatibility. 2.0+ versions of the schema will make this formally mandatory in an XML sense. ",
        alias="creationTime",
    )
    start_time: Optional[str] = Field(
        default=None, description="The instant at which the job started execution. ", alias="startTime"
    )
    end_time: Optional[str] = Field(
        default=None, description="The instant at which the job finished execution. ", alias="endTime"
    )
    execution_duration: Optional[StrictInt] = Field(
        default=None,
        description="The duration (in seconds) for which the job should be allowed to run - a value of 0 is intended to mean unlimited - returned at /{jobs}/{job_id}/executionduration ",
        alias="executionDuration",
    )
    destruction: Optional[str] = Field(
        default=None,
        description="The time at which the whole job + records + results will be destroyed. Returned at /{jobs}/{job_id}/destruction ",
    )
    parameters: Optional[Parameters] = None
    results: Optional[Results] = None
    error_summary: Optional[ErrorSummary] = Field(default=None, alias="errorSummary")
    job_info: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None,
        description="This is arbitrary information that can be added to the job description by the UWS implementation. ",
        alias="jobInfo",
    )
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobSummary:
        ...
        _obj = cls.model_validate(
            {
                ...
                "errorSummary": ErrorSummary.from_dict(obj.get("errorSummary"))
                if obj.get("errorSummary") is not None
                else None,
